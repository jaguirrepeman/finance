"""
data_providers_async.py — Proveedores de datos financieros (async).

Versión async de data_providers.py usando httpx.AsyncClient con connection
pooling. Todos los métodos de I/O son ``async def``.
